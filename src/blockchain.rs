...
impl Transaction {
    pub fn new(keys: &KeyMaster, to_address: String, ammount: u64) -> Transaction {
    ...
    pub fn verify(&self) -> bool {
        ...
        return keys.verify_with_public_key(
...
impl Blockchain {
    ...
    pub fn mine_pending_transactions(&mut self, keys: &KeyMaster, reward_address: String) {
        let reward: Transaction =
            Transaction::new(keys, reward_address.clone(), self.mining_reward);
